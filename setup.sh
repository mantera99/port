...
# Created     : 06-10-2022 ( 6 Sep 2022 )
# OS Support  : Ubuntu & Debian
# Auther      : FahmiStore
# WebSite     : ora
# Github      : github.com/Fahmiiiiiiii
# License     : MIT License
# ==================================================================
...
# // Ruless Accpet
wget -q -O /etc/wildydev21/Rules "https://raw.githubusercontent.com/Fahmiiiiiiii/vpn-script/Resource/Other/Rules.txt";
clear;
...
wget -qO- --inet4-only 'https://raw.githubusercontent.com/Fahmiiiiiiii/vpn-script/get-ip_sh' | bash;
...
clear
echo -e "${YELLOW}--------------------------------------------------${NC}
   Welcome To FahmiStore VPN Script V1.0 Stable
      This Script will Auto Setup VPN Server
                Author : ${GREEN}FahmiStore${NC}
        © Copyright 2022-2023 By ${GREEN}FahmiStore${NC}
${YELLOW}--------------------------------------------------${NC}";
...
email_nya="service@mailprabowo.my.id";
html_parse='true';
else
...
# ============================================================
# (C) Copyright 2022-2023 By FahmiStore
...
# // String / Request Data
export Random_Number=$( </dev/urandom tr -dc 1-$( curl -s https://raw.githubusercontent.com/Fahmiiiiiiii/vpn-script/Data/domain.list | grep -E Jumlah | cut -d " " -f 2 | tail -n1 ) | head -c1 | tr -d '\r\n' | tr -d '\r');
export Domain_Hasil_Random=$( curl -s curl -s https://raw.githubusercontent.com/Fahmiiiiiiii/vpn-script/Data/domain.list | grep -E Domain$Random_Number | cut -d " " -f 2 | tr -d '\r' | tr -d '\r\n');
export DOMAIN_BARU="$(</dev/urandom tr -dc a-x1-9 | head -c7 | tr -d '\r' | tr -d '\r\n').${Domain_Hasil_Random}";
export EMAIL_CLOUDFLARE="formlbbacc07@gmail.com";
export API_KEY_CLOUDFLARE="474fdae7cd5013d3a6151bcd1a2e14b5db85b";
...
# // Input Result To VPS
echo "$DOMAIN_BARU" > /etc/wildydev21/domain.txt;
...
wget -q -O /root/.acme.sh/acme.sh "https://raw.githubusercontent.com/Fahmiiiiiiii/vpn-script/Resource/Core/acme.sh";
...
# // Installing Requirement
wget -q -O /root/requirement.sh "https://raw.githubusercontent.com/Fahmiiiiiiii/vpn-script/Stable/1.0/setup/requirement.sh";
chmod +x requirement.sh;
./requirement.sh;

# // SSH & WebSocket Install
wget -q -O /root/ssh-ssl.sh "https://raw.githubusercontent.com/Fahmiiiiiiii/vpn-script/Stable/1.0/setup/ssh-ssl.sh";
chmod +x ssh-ssl.sh;
./ssh-ssl.sh;

# // Nginx Install
wget -q -O /root/nginx.sh "https://raw.githubusercontent.com/Fahmiiiiiiii/vpn-script/Stable/1.0/setup/nginx.sh";
chmod +x nginx.sh;
./nginx.sh;

# // XRay-Mini Install
wget -q -O /root/xray-mini.sh "https://raw.githubusercontent.com/Fahmiiiiiiii/vpn-script/Stable/1.0/setup/xray-mini.sh";
...
# // OpenVPN Install
wget -q -O /root/ovpn.sh "https://raw.githubusercontent.com/Fahmiiiiiiii/vpn-script/Stable/1.0/setup/ovpn.sh";
chmod +x ovpn.sh;
./ovpn.sh;

# // Wireguard Install
wget -q -O /root/wg-set.sh "https://raw.githubusercontent.com/Fahmiiiiiiii/vpn-script/Stable/1.0/setup/wg-set.sh";
chmod +x wg-set.sh;
./wg-set.sh;

# // ShadowsocksR Install
wget -q -O /root/ssr.sh "https://raw.githubusercontent.com/Fahmiiiiiiii/vpn-script/Stable/1.0/setup/ssr.sh";
chmod +x ssr.sh;
./ssr.sh;

# // Installing Menu
wget -q -O /root/menu-setup.sh "https://raw.githubusercontent.com/Fahmiiiiiiii/vpn-script/Stable/1.0/menu/menu-setup.sh";
